...
const Login = () => {
  return (
        ...
        <div className="flex items-center justify-center py-72 bg-gray-400 w-full relative" style={{ backgroundImage: `url(${image.landingbg})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat',backgroundAttachment:'fixed' }}>
