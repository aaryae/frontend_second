    ...
    <>
      <div className='bg-[#b5aa6f3b] py-60'>
        <div className='index  max-w-7xl mx-auto'>
          ...
          <div className='py-20'>
            <Paragraph value='A nice thank you gives them a sense that your company cares about their business and wants them to have a positive experience with your brand even after the transaction is complete. You can never underestimate the value of customer appreciation!' />
